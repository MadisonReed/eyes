...
function stringify(obj, options) {
    ...
    result = (function (obj) {
        switch (typeOf(obj)) {
            ...
            case "weakmap"  : return stylize("WeakMap", 'special');
            case "weakset"  : return stylize("WeakSet", 'special');
        }
    })(obj);
...
function typeOf(value) {
    var s = typeof(value),
        types = [Object, Array, String, RegExp, Number, Function, Boolean, Date, Set, Map, WeakMap, WeakSet];
